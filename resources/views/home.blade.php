...
<!--Hero-->
 <section class="jumbotron text-center">
            <img src="https://i.postimg.cc/FR1L8Hwn/1267736.jpg" alt="aaa" width="200" height="200" class=" rounded-circle ">
            <h1 class="display-4">Marcell</h1>
            <p class="lead">12 RPL 2 | Absen 31</p>
        </section>
